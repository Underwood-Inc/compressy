...
execute unless score #count cb.temp matches 9.. run return run tellraw @s [{"text":"[Compressed Blocks] ","color":"gold"},{"text":"Need at least 9 blocks to compress!","color":"red"}]
