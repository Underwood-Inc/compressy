...
execute store result storage compressedblocks:temp current_level int 1 run data get entity @s SelectedItem.components."minecraft:custom_data".compressed_level
...
function compressedblocks:compressor/give_recompressed with storage compressedblocks:temp
