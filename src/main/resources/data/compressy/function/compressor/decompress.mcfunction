...
execute if score #level cb.temp matches 1 run function compressy:compressor/decompress_to_base with storage compressy:temp

# If level > 1, give back 9 blocks of level-1
execute if score #level cb.temp matches 2.. run function compressy:compressor/decompress_to_lower with storage compressy:temp
