...
execute store result score @s cb.temp run clear @s #compressy:compressible 0

# If player has compressible items, try to compress
execute if score @s cb.temp matches 1.. run function compressy:compressor/compress
