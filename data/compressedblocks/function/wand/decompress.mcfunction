...
execute if score #level cb.temp matches 1 run function compressedblocks:wand/decompress_to_base with storage compressedblocks:temp

# If level > 1, give level-1 blocks
execute if score #level cb.temp matches 2.. run function compressedblocks:wand/decompress_to_lower with storage compressedblocks:temp
