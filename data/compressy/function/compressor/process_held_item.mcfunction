...
execute if data entity @s SelectedItem.components."minecraft:custom_data".compressed_level run function compressy:compressor/recompress
execute unless data entity @s SelectedItem.components."minecraft:custom_data".compressed_level run function compressy:compressor/initial_compress
