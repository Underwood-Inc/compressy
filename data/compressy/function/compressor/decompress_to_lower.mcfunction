...
execute store result storage compressy:temp new_level int 1 run scoreboard players get #level cb.temp
...
execute store result storage compressy:temp current_level int 1 run scoreboard players add #level cb.temp 1
execute store result storage compressy:temp current_level int 1 run scoreboard players get #level cb.temp
scoreboard players remove #level cb.temp 1
