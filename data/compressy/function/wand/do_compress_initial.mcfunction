...
$item modify entity @s weapon.offhand compressy:remove_$(used_count)
...
$tellraw @s [{"text":"[Compressy] ","color":"gold"},{"text":"Compressed $(give_count)x to Level 1!","color":"green"}]
